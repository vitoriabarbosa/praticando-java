 ...
 * 
 * Implemente um programa, que permita ao usuário ingressar os dados de dureza, teor de carvão e a resistência da tração e como saída mostre a pontuação do aço. 
 * (Resolva com if-else)
 * 
